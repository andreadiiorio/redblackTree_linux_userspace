...
///TODO REMOVE AUGMENTED DEP HERE!!
...
__rb_erase(struct rb_node *node, struct rb_root *root)
{
	...
	if (!tmp) {
		...
		if (!tmp) {
			...
			///augment->copy(node, successor); //TODO LESS_DEPENDENCIES-DEL AUGMENT
		} else {
			/*
			...
			///augment->copy(node, successor); //TODO LESS_DEPENDENCIES-DEL AUGMENT
			///augment->propagate(parent, successor); //TODO LESS_DEPENDENCIES-DEL AUGMENT
		}
	...
	///augment->propagate(tmp, NULL); //TODO LESS_DEPENDENCIES-DEL AUGMENT
	return rebalance;
}
/////////////////////////////
